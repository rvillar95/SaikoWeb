                ...
                <nav class="navbar navbar-static-top" role="navigation">
                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        <ul class="nav navbar-nav navbar-left">
                            ...
                            <li class="active"><a class="page-scroll " href="<?php echo base_url() ?>Comentarios" style="font-family: FerroRosso; font-size: 30px; padding-top: 30px;">Comentarios</a></li>
                    ...
                    <div class="row">
                            ...
                            <div class="panel-body">
                                <div class="ibox">
                                    <div class="ibox-title" style="background-color: #d12a11;">
                                        <h5 style="color: white">Formulario Comentario</h5>
                                    </div>
                                    <div class="ibox-content" style="padding: 0px;">
                                        <div class="row" style="padding: 20px;">
                                            ...
                                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <input type="text" required id="descripcion" placeholder="Ingrese una breve descripcion" class="form-control">
                                            </div>
                                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <label>Link Comentario</label>
                                                <input type="text" required id="link" placeholder="https://www.facebook.com/pascuala.delivery/media_set/?set=a.1031167983733334" class="form-control">
                                            </div>
                                            <div class="form-group form-group col-lg-12 col-md-12 col-sm-4 col-xs-12"><button type="submit" id="btnAddEvento" class="btn btn-primary" style="background-color: #d12a11; color: white; ">Agregar Comentario</button></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-8">
                            <div class="panel-body">
                                <div class="ibox">
                                    <div class="ibox-title" style="background-color: #d12a11;">
                                        <h5 style="color: white">Tabla Comentarios</h5>
                                    </div>
                                    <div class="ibox-content" style="padding: 0px;">
                                        <div class="row" style="padding: 20px;">
                                            <h2><strong>Registros de Comentarios</strong></h2>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.tablaEvento').DataTable({
                ...
                "ajax": {
                    url: "<?php echo base_url() ?>getComentarios",
                    type: 'GET'
                },
                "columnDefs": [{
                        "targets": 5,
            ...
            $("body").on("click", "#btnEditar", function(e) {
                ...
                editarEstadoComentario($(idProducto).text(), $(estado).text());
                setTimeout(() => {
                    var table = $('.tablaEvento').DataTable();
                    table.ajax.reload(function(json) {
