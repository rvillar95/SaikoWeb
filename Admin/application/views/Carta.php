...
<body class="top-navigation">
                ...
                <nav class="navbar navbar-static-top" role="navigation">
                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        <ul class="nav navbar-nav navbar-left">
                            ...
                            <li class="active"><a class="page-scroll " href="<?php echo base_url() ?>Carta" style="padding-top: 30px; color:#58167D;">Carta</a></li>
                    ...
                    <div class="row">
                            ...
                            <div class="panel-body">
                                <div class="ibox">
                                    <div class="ibox-title" style="background-color: #58167D;">
                                        <h5 style="color: white">Formulario Carta</h5>
                                    </div>
                                    <div class="ibox-content" style="padding: 0px;">
                                        <div class="row" style="padding: 20px;">
                                            ...
                                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <input type="text" id="wtf" name="wtf" class="form-control">
                                            </div>
                                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <label>Foto Carta</label>
                                                <input type="file" name="foto" id="foto" placeholder="Seleccione el archivo" class="form-control">
                                            </div>
                                            <div class="form-group form-group col-lg-12 col-md-12 col-sm-4 col-xs-12"><button type="submit" id="btnAddCarta" class="btn btn-primary" style="background-color: #58167D; color: white; ">Agregar Carta</button></div>
                                            <!-- </form>-->
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-8">
                            <div class="panel-body">
                                <div class="ibox">
                                    <div class="ibox-title" style="background-color: #58167D;">
                                        <h5 style="color: white">Tabla Carta</h5>
                                    </div>
                                    <div class="ibox-content" style="padding: 0px;">
                                        <div class="row" style="padding: 20px;">
                                            <h2><strong>Registros de Carta</strong></h2>
                                            <div class="table-responsive">
                                                <table id="tablaCarta" class="table table-striped table-bordered table-hover tablaCarta">
                                                    <thead>
                                                        <tr>
                                                            <th>Nombre</th>
                                                            <th>Foto</th>
    ...
    <script>
        $("body").on("click", "#editarEstadoCarta", function(e) {
            e.preventDefault();
            ...
            $.ajax({
                ...
                if (msg.msg == "ok") {
                    setTimeout(() => {
                        var table = $('.tablaCarta').DataTable();
                        table.ajax.reload(function(json) {
                            $('#editarEstadoCarta').val(json.lastInput);
                        });
                    }, 500);
        ...
        $("#btnAddCarta").click(function(e) {
            e.preventDefault();
            var nombreeee = $("#wtf").val();
            var file_data = $('#foto').prop('files')[0];
            if (nombreeee == "") {
                swal("Problemas", "Ingrese un nombre para la carta.", "warning");
            }else{
                if (file_data == undefined) {
                    ...
                    form_data.append('nombre',nombreeee);
                    $.ajax({
                        url: 'addCarta', // point to server-side PHP script 
        ...
        $('.tablaCarta').DataTable({
            ...
            "ajax": {
                url: "<?php echo base_url() ?>getCarta",
                type: 'GET'
            },
